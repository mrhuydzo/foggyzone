...
<!--[if lte IE 9 ]>
<html class="ie lt-ie9" <?php language_attributes(); ?>> <![endif]--><!--[if (gte IE 9)|!(IE)]><!-->
<html <?php language_attributes(); ?>> <!--<![endif]-->
<head>
    <meta charset="<?php bloginfo('charset'); ?>" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
    <meta name="keywords" content="foggyzone,vape shop,vape chuan,mua ban vape,vape ha noi,juice,coil,box,tank,rda,rta,phu kien vape,vape auth">
    <meta name="description" content="Cửa hàng Vape  chất lượng, uy tín, đa dạng. Chúng tôi chuyên cung cấp thiết bị & phụ kiện Vape, các dòng E-Juice chất lượng cao, chính hãng 100%" />
    <meta name="author" content="foggyzone.vn" />
    <meta name="generator" content="foggyzone.vn" />
    <meta name="robots" content="index,follow" />
    <meta name="Googlebot" content="index,follow" />
    <meta name="RATING" content="GENERAL" />
    <meta name="copyright" content="foggyzone.vn" />

    <meta property="og:url" content="foggyzone.vn" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="FOGGY ZONE - Vape Shop chuan | Vì một cộng đồng vape lành mạnh và an toàn" />
    <meta property="og:description" content="Cửa hàng Vape chất lượng, uy tín, đa dạng. Chúng tôi chuyên cung cấp thiết bị & phụ kiện Vape, các dòng E-Juice chất lượng cao, chính hãng 100%" />
    <meta property="og:site_name" content="Foggy zone">
    <meta property="og:locale" content="en_US">
    <meta property="article:author" content="foggyzone">
    <meta property="og:image" content="http://foggyzone.vn/wp-content/uploads/2016/08/logo.jpg" />

    <meta itemprop="name" content="FOGGY ZONE - Vape Shop chuan | Vì một cộng đồng vape lành mạnh và an toàn" />
    <meta itemprop="description" content="Cửa hàng Vape chất lượng, uy tín, đa dạng. Chúng tôi chuyên cung cấp thiết bị & phụ kiện Vape, các dòng E-Juice chất lượng cao, chính hãng 100%" />
    <meta itemprop="image" content="http://foggyzone.vn/wp-content/uploads/2016/08/logo.jpg" />

    <link rel="profile" href="http://gmpg.org/xfn/11" />
    <link rel="pingback" href="<?php bloginfo('pingback_url'); ?>" />
    <meta property="fb:app_id" content="1419092231449310" />
    <meta property="fb:admins" content="G1SAT5vYuiW" />
    <?php wp_head(); ?>
</head>
<div id="fb-root"></div>
<script>(function (d, s, id) {
        ...
        js.id = id;
        js.src = "//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.8&appId=1419092231449310";
...
<div id="wrapper"<?php if ($flatsome_opt['box_shadow']) echo ' class="box-shadow"'; ?>>
    <div class="header-wrapper before-sticky">
                                    ...
                                    <li class="account-dropdown menu-parent-item">
                                        ...
                                        if (is_user_logged_in()) { ?>
                                            ...
                                            <div class="nav-dropdown">
                                                <ul>
                                                    <?php if (has_nav_menu('my_account')) : ?><?php
                                                        wp_nav_menu(array(
                                                        ...
                                                        ?><?php else: ?>
                                                        <li>Define your My Account dropdown menu in
                                                            <b>Appearance > Menus</b></li>
                                                    <?php endif; ?>
                                                </ul>
                ...
                <div class="large-12 columns header-container">
                    ...
                    <div class="right-links">
                        <ul <?php if ($flatsome_opt['nav_position'] == 'top_right'){ ?>id="site-navigation"<?php } ?> class="header-nav">
                            ...
                            <?php if ($flatsome_opt['nav_position'] == 'top_right') { ?><?php if (has_nav_menu('primary')) { ?>
                                ...
                                <?php } ?><?php } ?><?php } // primary-nav right style ?>
                            ...
                            <?php if (!$flatsome_opt['catalog_mode']) { ?>
                                ...
                                <?php if (!isset($flatsome_opt['show_cart']) || $flatsome_opt['show_cart'] == 1) { ?><?php if (function_exists('wc_print_notices')) { ?>
        ...
        <?php if ($flatsome_opt['nav_position'] == 'bottom' || $flatsome_opt['nav_position'] == 'bottom_center') { ?>
            ...
            <div class="wide-nav <?php echo $flatsome_opt['nav_position_color']; ?> <?php if ($flatsome_opt['nav_position'] == 'bottom_center') {
                echo 'nav-center';
            } else {
                echo 'nav-left';
            } ?>">

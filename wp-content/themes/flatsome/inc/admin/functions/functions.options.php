...
$of_options[] = array( 	"name" 		=> "Share icons",
						...
						"type" 		=> "multicheck",
						"options" 	=> array("facebook" => "Facebook","linkedin" => "LinkedIn","twitter" => "Twitter","email" => "Email","pinterest" => "Pinterest","googleplus" => "Google Plus","vk" => "VKontakte","tumblr" => "Tumblr", "whatsapp" => "WhatsApp (Only for Mobile)")
);
